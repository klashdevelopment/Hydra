...
var _exm_games = ['DOCUMENTATION', 'PIXEL_ART_EDITOR', 'polyrhythm', 'tetris', '2d-physics', 'sounds', 'coin-game', 'coins', 'dash', 'basic-3d', 'pixel-character', 'ultrawide', 'simple', 'snake', 'shapes', 'space-dodge', 'space-invaders', 'tilemap', 'brick-breaker', 'shooty-thingy', 'data', 'asteroid-ai'];
var _exm_adv = ['portal'];
