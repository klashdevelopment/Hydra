var _exm_lib = new HydraCanvasLib('game', {canvasHeight: 600, canvasWidth: 800});
var games = ['coin-game', 'coins', 'dash', 'pixel-character', 'simple', 'space-dodge', 'space-invaders', 'tilemap', 'geometry-dash', 'brick-breaker', 'data']
